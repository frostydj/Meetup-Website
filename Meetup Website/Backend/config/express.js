...
module.exports = function () {
    ...
    app.use(bodyParser.raw({ type: 'image/jpeg', limit: '25mb', extended: true }));
    app.use(bodyParser.raw({ type: 'image/png', limit: '25mb', extended: true  }));
    app.use(bodyParser.raw({ type: 'image/gif', limit: '25mb', extended: true  }));
